...
void main() async {
  ...
  runApp(const AccessoriesCategoryScreen());
}
...
class AccessoriesCategoryScreen extends StatefulWidget {
  ...
  @override
  State<AccessoriesCategoryScreen> createState() => _AccessoriesCategoryScreenState();
}
...
class _AccessoriesCategoryScreenState extends State<AccessoriesCategoryScreen> {
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        centerTitle: true,
        title: AppbarTitle(text: "Accessories Category"));
  }
