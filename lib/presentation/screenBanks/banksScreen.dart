...
void main() async {
  ...
  runApp(const BanksCategoryScreen());
}


// ignore: must_be_immutable
class BanksCategoryScreen extends StatefulWidget {
  const BanksCategoryScreen({super.key});

  @override
  State<BanksCategoryScreen> createState() => _BanksCategoryScreenState();
}


class _BanksCategoryScreenState extends State<BanksCategoryScreen> {
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        centerTitle: true,
        title: AppbarTitle(text: "Banks Category"));
  }
