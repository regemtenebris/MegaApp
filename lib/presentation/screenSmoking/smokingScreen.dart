...
void main() async {
  ...
  runApp(const SmokingCategoryScreen());
}


// ignore: must_be_immutable
class SmokingCategoryScreen extends StatefulWidget {
  const SmokingCategoryScreen({super.key});

  @override
  State<SmokingCategoryScreen> createState() => _SmokingCategoryScreenState();
}


class _SmokingCategoryScreenState extends State<SmokingCategoryScreen> {
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        centerTitle: true,
        title: AppbarTitle(text: "Smoking Category"));
  }
