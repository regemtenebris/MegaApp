...
void main() async {
  ...
  runApp(const CarsCategoryScreen());
}


// ignore: must_be_immutable
class CarsCategoryScreen extends StatefulWidget {
  const CarsCategoryScreen({super.key});

  @override
  State<CarsCategoryScreen> createState() => _CarsCategoryScreenState();
}


class _CarsCategoryScreenState extends State<CarsCategoryScreen> {
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        centerTitle: true,
        title: AppbarTitle(text: "Cars Category"));
  }
