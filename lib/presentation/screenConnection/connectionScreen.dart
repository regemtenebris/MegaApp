...
void main() async {
  ...
  runApp(const ConnectionCategoryScreen());
}


// ignore: must_be_immutable
class ConnectionCategoryScreen extends StatefulWidget {
  const ConnectionCategoryScreen({super.key});

  @override
  State<ConnectionCategoryScreen> createState() => _ConnectionCategoryScreenState();
}


class _ConnectionCategoryScreenState extends State<ConnectionCategoryScreen> {
      ...
      itemBuilder: (context, index) {
        return Container(
          ...
          child: GestureDetector(
            onTap: (){
              final destName = _searchResult[index].id;
              print(destName);
              showDialog(
                context: context,
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        centerTitle: true,
        title: AppbarTitle(text: "Connection Providers Category"));
  }
